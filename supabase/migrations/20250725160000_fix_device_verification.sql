-- Fix device verification workflow
-- The validate_watch function should verify unverified devices and then return account info

-- Drop and recreate get_account_by_wearer_id to handle both verified and unverified devices
